...
namespace zd5.Controllers
{
    ...
    public class WarehousesController : ControllerBase
    {
        ...
        public WarehousesController(IWarehousesDataAccessLayer dal, IConfiguration configuration)
        {
            _dal = dal;
        ...
        public async Task<IActionResult> Post([FromBody] WarehousesDto request)
        {
            ...
            await _dal.UpdateFulfilledAtDateAsync(request.IdProduct, request.Amount);
            int id = await _dal.CreateOrderAsync(request);
